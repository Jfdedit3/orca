...
```lua
loadstring(
  game:HttpGetAsync("https://raw.githubusercontent.com/Jfdedit3/orca/master/public/latest.improved.lua")
)()
```
...
```lua
loadstring(
  game:HttpGetAsync("https://raw.githubusercontent.com/Jfdedit3/orca/master/public/snapshot.lua")
)()
```
