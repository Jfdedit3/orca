	...
	return (
		...
		>
			...
			<Canvas padding={{ top: 24, left: 24 }}>
				...
				<Label index={2} text="By z4trox" position={px(0, 63)} transparency={0.1} />
				<Label index={3} text="Custom Orca build" position={px(0, 86)} transparency={0.24} />
				<Label index={4} text="Jfdedit3/orca" position={new UDim2(0, 0, 1, -40)} transparency={0.38} />
			</Canvas>
		</Card>
	);
}
